function [ b_cells_trial, number_recycled_b_cells_trial, exit_cells_trial, final_cycle ] = runTrial( b_cells_trial, exit_cells_trial, number_recycled_b_cells_trial, conc, a_act, a_threshold, p_mut, p_CDR, p_FR_lethal, p_recycle, t_cell_selection, n_max_Bcells, n_cycle_max )

cycle_number = 1;
%disp(['Cycle Number ' num2str(cycle_number)]);
number_recycled_b_cells_trial(cycle_number) = size(b_cells_trial,2);

%%%%%% TO DO, test the breadth of the exit_cells. Average affinity for the
%%%%%% 2 Ags?
